...
class Csvexceptionstock(Exception):
    """
    General Exception for the csvexceptionStock Class
    """
    pass

class CompanyStore(object):
    """
    ...
    def read_file(self, fp = None):
        if fp:
            try:
                ...
                raise Csvexceptionstock ("Error Opening File")
    ...
    def check_format(self, line = None, header = None):
        try:
            ...
            raise Csvexceptionstock ("CSV File contain Errors") 
...
if __name__ == '__main__':
    from unittesthighshare import TestcsvStock   
    ...
    try:
        ...
        for o, value in fnopt:
            if o == '-f':
                try:
                    sa = CompanyStore(value)
                    sa.print_highest()
                    sa.close_fp

                except (Csvexceptionstock), e:
                    print e
